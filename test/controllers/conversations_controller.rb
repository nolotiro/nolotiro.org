...
class ConversationsControllerTest < ActionController::TestCase
  ...
  it 'should redirect to signup to create a message as anon' do
    get :new, params: { user_id: @user1.id }
    assert_redirected_to new_user_session_url
  end

  it 'should get form to create a message as an user' do
    sign_in @user1
    get :new, params: { user_id: @user2.id }
    assert_response :success
  end

  it 'should create a message, show it and let the other user reply it' do
  ...
  it 'should get list of conversations as user' do
    sign_in @user1
    get :index
    assert_response :success
  end

  it 'should not get list of conversations as anon' do
    get :index
    assert_redirected_to new_user_session_url
  end

  it 'should not get list of conversations to/from another user' do
    sign_in @user1
    assert_difference('Conversation.count') do
      post :create,
           params: {
  ...
  it 'should not permit sender param for message' do
    sign_in @user1
    post :create,
         params: {
